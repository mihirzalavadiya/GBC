      ...
      {plateform ? (
        <Row className={`flex space-between`}>
          <Col className="flex column-center pointer" onClick={backHandler}>
            <img
              alt=""
              src={typeof backBtn === 'object' ? backBtn.src : backBtn}
            />
            <span className="margin-left-20 bold font-size-16 line-height-22 text-3761C8">
              Back
            </span>
          </Col>
          ...
          {plateform && userDetails?.kycStatus === 'DRAFT' && (
            <Col className="flex end">
              <button
                className="transparent-btn-header pointer"
